...
//@Controller
//public class TestingContriller {
//    @ResponseBody
...
//    //  http://localhost:8080/cbicApi/cbic/MonthYear/return_filling/month?type=last3month&month_date=2023-05-01&zone_code=70
//    // http://localhost:8080/cbicApi/cbic/MonthYear/return_filling/month?type=monthly&month_date=2023-05-31
//    // http://localhost:8080/cbicApi/cbic/MonthYear/return_filling/month?type=comm_name&month_date=2023-05-31&zone_code=70
...
//    }
//
//// Refunds last three month details****************************************
//
//    @ResponseBody
//    @RequestMapping(value = "refunds/month")
////  http://localhost:8080/cbicApi/cbic/MonthYear/refunds/month?type=last3month&month_date=2024-04-01&zone_code=70
//// http://localhost:8080/cbicApi/cbic/MonthYear/refunds/month?type=monthly&month_date=2023-05-31
//// http://localhost:8080/cbicApi/cbic/MonthYear/refunds/month?type=comm_name&month_date=2023-05-31&zone_code=70
//    public Object refunds(@RequestParam String type, @RequestParam String month_date, @RequestParam(required = false) String zone_code, @RequestParam(required = false) String comm_name) {
//        List<MonthlyYearlyScore> allGstaList = new ArrayList<>();
//        MonthlyYearlyScore totalScore = null;
//        Connection con = null;
//        ResultSet rsGst14aa= null;
...
//                        + "    zc.ZONE_NAME,\r\n"
//                        + "    cc.ZONE_CODE,\r\n"
//                        + "    'Refunds' AS parameter_name,\r\n"
//                        + "    \r\n"
//                        + "    (SUM(14c.age_breakup_above60_no) * 100 / SUM(14c.opening_balance_no + 14c.RFD_01_NO - 14c.RFD_03_NO - 14c.RFD_06_SANCTIONED_NO - 14c.RFD_06_REJECTED_NO)) AS total_score_of_month,\r\n"
//                        + "\r\n"
//                        + "    (\r\n"
//                        + "        SELECT \r\n"
//                        + "            (SUM(sub1.age_breakup_above60_no) * 100 / SUM(sub1.opening_balance_no + sub1.RFD_01_NO - sub1.RFD_03_NO - sub1.RFD_06_SANCTIONED_NO - sub1.RFD_06_REJECTED_NO))\r\n"
//                        + "        FROM \r\n"
//                        + "            mis_dpm_gst_4 AS sub1\r\n"
//                        + "        JOIN \r\n"
//                        + "            mis_gst_commcode AS cc1 ON cc1.COMM_CODE = sub1.COMM_CODE\r\n"
//                        + "        WHERE \r\n"
//                        + "            sub1.MM_YYYY = DATE_FORMAT(DATE_SUB('" + month_date + "', INTERVAL 1 MONTH), '%Y-%m-01')\r\n"
//                        + "            AND cc1.ZONE_CODE = cc.ZONE_CODE\r\n"
//                        + "    ) AS total_score_previous_month,\r\n"
//                        + "\r\n"
//                        + "    (\r\n"
//                        + "        SELECT \r\n"
//                        + "            (SUM(sub2.age_breakup_above60_no) * 100 / SUM(sub2.opening_balance_no + sub2.RFD_01_NO - sub2.RFD_03_NO - sub2.RFD_06_SANCTIONED_NO - sub2.RFD_06_REJECTED_NO))\r\n"
//                        + "        FROM \r\n"
//                        + "            mis_dpm_gst_4 AS sub2\r\n"
//                        + "        JOIN \r\n"
//                        + "            mis_gst_commcode AS cc2 ON cc2.COMM_CODE = sub2.COMM_CODE\r\n"
//                        + "        WHERE \r\n"
//                        + "            sub2.MM_YYYY = DATE_FORMAT(DATE_SUB('" + month_date + "', INTERVAL 2 MONTH), '%Y-%m-01')\r\n"
//                        + "            AND cc2.ZONE_CODE = cc.ZONE_CODE\r\n"
//                        + "    ) AS total_score_previous_month_2\r\n"
//                        + "\r\n"
//                        + "FROM \r\n"
//                        + "    mis_gst_commcode AS cc\r\n"
...
//                    String formattedTotal3 = String.format("%.2f", previous_t_score_2);
//                    double total_score_previous_month_2 = Double.parseDouble(formattedTotal3);
//                    totalScore = new MonthlyYearlyScore(zoneName,commName, zone_code,"Refunds", total_score_of_month, total_score_previous_month,
//                            total_score_previous_month_2, total_score_of_year, total_score_previous_year, total_score_previous_year_2);
//                    allGstaList.add(totalScore);
//
//                }
